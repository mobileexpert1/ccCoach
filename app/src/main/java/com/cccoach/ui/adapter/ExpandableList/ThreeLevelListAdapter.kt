...
import com.cccoach.ui.adapter.ExpandableList.SecondLevelAdapter
import com.cccoach.utils.SecondLevelExpandableListView
...
class ThreeLevelListAdapter(
    ...
    override fun getGroupView(
        ...
        val ivMainDropDown = convertView!!.findViewById<ImageView>(R.id.ivMainDropDown)

        if (isExpanded) {
            ivMainDropDown.setImageResource(R.drawable.ic_up);
        } else {
            ivMainDropDown.setImageResource(R.drawable.ic_down);
        }
