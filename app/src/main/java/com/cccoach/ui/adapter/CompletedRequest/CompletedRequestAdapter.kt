package com.cccoach.ui.adapter.CompletedRequest
...
class CompletedRequestAdapter(val context: Context, private var listener: ClickListeners) : RecyclerView.Adapter<CompletedRequestAdapter.ViewHolder>() {
