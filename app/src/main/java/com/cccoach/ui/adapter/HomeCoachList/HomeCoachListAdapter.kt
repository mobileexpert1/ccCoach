package com.cccoach.ui.adapter.HomeCoachList
...
class HomeCoachListAdapter(val context: Context, private var listener: ClickListeners) : RecyclerView.Adapter<HomeCoachListAdapter.ViewHolder>() {
