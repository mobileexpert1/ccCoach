package com.cccoach.ui.adapter.MyRequests
...
class MyRequestAdapter(val context: Context, private var listener: ClickListeners) : RecyclerView.Adapter<MyRequestAdapter.ViewHolder>() {
